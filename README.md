...
Install the [AutoMapper](https://github.com/AutoMapper/AutoMapper) library and call its `Map` method to assign all field values of the edit model to the corresponding fields of the data item simultaneously.
